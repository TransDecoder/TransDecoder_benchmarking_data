...
def main():
    ...
    select_athal(prediction_list, long_orfs_scored_file + ".athal_tree.gff", predicted_orf_coords)
...
def select_athal(prediction_list, output_file, predicted_orf_coords):
    ...
    for prediction in prediction_list:
        ...
        if score_1 > 0:
            if score_1 < 0.009:
                if orf_length < 418 and not s1_max_all:
                    pass_orf = False
        elif orf_length < 548:
            pass_orf = False
